...
- [7th semester](./07/).
    ...
    |  Code   |                  Subject                  | Credits | Grade |
    |:-------:|:-----------------------------------------:|:-------:|:-----:|
    | 204028C |  Inglés fines generales y académicos IV   |    2    |       |
    | 750022C |          Inteligencia artificial          |    4    |       |
    | 750023C | Infraestructuras paralelas y distribuidas |    3    |       |
    | 750027C |        Desarrollo de software III         |    3    |       |
